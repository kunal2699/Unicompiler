...
def add_songs():
    songs = filedialog.askopenfilenames(initialdir="E:/New folder (2)/uniCompiler-master/uniCompiler-master/MP3 Player/", title="Choose a Song", filetypes=(("mp3 files", "*.mp3"), ))
    for song in songs:
        song = song.replace("E:/New folder (2)/uniCompiler-master/uniCompiler-master/MP3 Player/", "")
...
def play():
    ...
    song = f"E:/New folder (2)/uniCompiler-master/uniCompiler-master/MP3 Player/{song}.mp3"
